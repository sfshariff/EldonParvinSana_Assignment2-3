...
<div class="slide story" id="slide-1" data-slide="1">
	...
	%>
		...
		<form action="../ReadAvailableQuiz" method="get">
		...
		<tr>
			...
			<td> 
				<form action="TakeQuiz" method=post>
					<input type="hidden" name="name" value="<%=quiz.getQuizName()%>">
					<button class="btn" name="id" value="<%=quiz.getId()%>" type="submit">Take Quiz</button>
				</form>	
			</td>
		</tr>
		<% } %>
