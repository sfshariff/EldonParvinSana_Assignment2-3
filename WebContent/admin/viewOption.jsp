...
<div class="navbar navbar-fixed-top" data-activeslide="1">
	...
	<div class="slide story" id="slide-1" data-slide="1">
		<div class="container">
			<div class="row title-row">
                <div class="col-12 font-light">View  <span class="font-semibold"> Options</span></div>
            </div><!-- /row -->
	...
	<table>
		<tr>
			<th style="text-align: center; font-size: 17px; padding:10px;">Option ID</th>
			<th style="text-align: center; font-size: 17px; padding:10px;">Question ID</th>
			<th style="text-align: center; font-size: 17px; padding:10px;">Option</th>
			<th style="text-align: center; font-size: 17px; padding:10px;">Answer</th>
		</tr>
		<%
			@SuppressWarnings("unchecked")
			ArrayList<Options> OptionList = (ArrayList<Options>) request
					.getAttribute("optionList");
			if (OptionList != null) {
		...
		<tr>
			...
			<td>
				<form action="FindOption" method=post>
					<button class="btn" name="id" value="<%=option.getId()%>" type="submit">Modify Option</button>
				</form>
			</td>
		</tr>
