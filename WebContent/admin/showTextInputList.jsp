...
<div class="navbar navbar-fixed-top" data-activeslide="1">
	...
	<div class="slide story" id="slide-1" data-slide="1">
		<div class="container">
			<div class="row title-row">
                <div class="col-12 font-light">Text Input <span class="font-semibold"> View</span></div>
            </div><!-- /row -->
	...
	<table>
		<tr>
			<th style="text-align: center; font-size: 17px; padding:10px;">TextInput ID</th>
		...
		<%
			...
			ArrayList<TextInput> TextInputList = (ArrayList<TextInput>) request
					.getAttribute("textInputList");
		...
		<tr>
			...
			<td>
				<form action="FindTextInput" method=post>
					<button name="id" value="<%=textInput.getId()%>" type="submit">Modify Text Input</button>
				</form>
			</td>
		</tr>
		<% } } %>
