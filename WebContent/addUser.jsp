<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
 <jsp:useBean id="formHandler" class="model.User" scope="request" />
		...
		<div class="container">
			...
			<div class="nav-collapse collapse navbar-responsive-collapse">
				<ul class="nav row">
					...
					<li data-slide="5" class="col-12 col-sm-2"><a id="menu-link-5" href="index.jsp#slide-5" title="Next Section"><span class="icon icon-heart"></span> <span class="text">REGISTER</span></a></li>
				</ul>
				<div class="row">
	...
	<div class="slide story" id="slide-1" data-slide="1">
		<div class="container">
			<div class="row title-row">
                <div class="col-12 font-light">Please enter your email and password below  <span class="font-semibold">to register</span></div>
            </div><!-- /row -->
